...
#include "../../Middlewares/Third_Party/FatFs/src/integer.h" //from FatFs middleware library
#include "../../Middlewares/Third_Party/FatFs/src/diskio.h" //from FatFs middleware library
#include "../../Middlewares/Third_Party/FatFs/src/ff_gen_drv.h" //from FatFs middleware library
...
DSTATUS USER_SPI_initialize (BYTE pdrv, SPI_HandleTypeDef *spi_handle);
